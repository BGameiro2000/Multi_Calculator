...
#Calculation
  if user_input_operation in Perimeter_expressions:
    ...
    if geometric_figure in Expressions_1:
      ...
      Number_of_sides_fig = input("How many sides?\n:")
      Number_of_sides_fig_int = int(Number_of_sides_fig)
      sides = list(range(0,Number_of_sides_fig_int))
      print(sides)
      for i in range(0, Number_of_sides_fig_int, 1):
      	sides[i] = float(input("Side " + str(i+1) + ": "))
      	i += 1
      print(sides)
      perimeter_fig = 0
      for i in sides:
